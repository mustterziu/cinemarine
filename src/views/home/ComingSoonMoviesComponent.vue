        ...
        <div class="card-carousel">
            <div class="card-carousel--overflow-container">
                <div class="card-carousel-cards" :style="{ transform: 'translateX' + '(' + currentOffset + 'px' + ')'}">
                    <div class="card-carousel--card" v-for="item in items"><img class="comingsoonMovies" :src="item.image"/>
...
<script>
    export default {
        name: "ComingSoonMoviesComponent",
        data() {
            return {
                currentOffset: 0,
                windowSize: 3,
                ...
                items: [
                    {name: 'Mulan', tag: ["Anime"], image: "/img/comingsoon/mulan.jpg"},
                    {name: 'Peaky Blinders', tag: ["Drama", "Action", "+18"], image: "/img/comingsoon/peakyblinders.jpg"},
                    {name: 'John Wick', tag: ["Action"], image: "/img/comingsoon/johnwick.jpg"},
